...
export default function InputPlayer() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-linear-to-b from-blue-50 via-white to-white">
            <div
            ...
            <input
                type="number"
                defaultValue={30}
                className="w-20 p-2 mb-4 text-center border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                onChange={(e) => {
