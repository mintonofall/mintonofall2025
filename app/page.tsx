...
export default function Home() {
    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center min-h-screen py-8 px-4 bg-linear-to-b from-blue-50 via-white to-white">
                <Image src="/logo512.png" alt="Mintonofall Logo" width={160} height={160} className="mb-6 drop-shadow-sm" />
                <form action={action} className="w-full max-w-sm bg-white p-8 rounded-2xl shadow-xl border border-blue-100">
                    <div className="mb-4">
                    ...
                    <div className="flex items-center justify-between">
                        <button
                            type="submit"
                            className="w-full bg-blue-500 hover:bg-blue-600 active:scale-[0.99] text-white font-semibold py-2.5 px-4 rounded-full shadow-sm transition-all"
                        >
                            로그인
                        </button>
                    </div>
                </form>
                <Link href={"/createUser"} className="mt-5 text-blue-600 hover:text-blue-700 font-medium">
                    가입
                </Link>
