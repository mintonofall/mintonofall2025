                ...
                <form onSubmit={handleWritePost} className="space-y-4">
                    ...
                    <div className="flex gap-2 justify-end pt-4">
                        <button
                            ...
                            className="bg-slate-300 px-4 py-2 rounded-lg hover:bg-slate-400 transition"
                        >
                            취소
                        </button>
                        <button
    ...
    if (view === "detail" && selectedPost) {
        return (
            <div className="max-w-3xl mx-auto bg-white p-4 sm:p-6 rounded-lg shadow-md w-full">
                ...
                <div className="text-xs sm:text-sm text-slate-500 mb-4 sm:mb-6 border-b pb-4 flex flex-col sm:flex-row sm:justify-between gap-2">
                    <span>
                        작성자:{" "}
                ...
                <div className="min-h-[150px] mb-8 whitespace-pre-wrap text-slate-800 leading-relaxed text-sm sm:text-base break-all">
                ...
                <div className="border-t pt-6">
                    ...
                    <div className="space-y-3 mb-6">
                        {selectedPost.comments.map((c) => (
                            <div key={c.id} className="bg-slate-50 p-3 sm:p-4 rounded-lg border border-slate-100">
    ...
    return (
        <div className="max-w-4xl mx-auto w-full">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-3">
                <h1 className="text-xl sm:text-3xl font-bold text-slate-800">모두의민턴 자유게시판</h1>
                <div className="w-full sm:w-auto flex gap-2 justify-end">
                    ...
                    <Link
                        href="/home"
                        className="bg-slate-500 text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg hover:bg-slate-600 transition font-medium text-sm sm:text-base"
                    >
                        홈으로
                    </Link>
                </div>
                    ...
                    <tbody>
                        {initialPosts.length === 0 ? (
                            ...
                            initialPosts.map((post: Post, index: number) => (
                                ...
                                >
                                    <td className="p-3 sm:p-4 text-center text-slate-400 font-medium text-xs sm:text-base">
                                    ...
                                    <td className="p-3 sm:p-4 text-center text-slate-600 text-xs sm:text-sm whitespace-nowrap">
