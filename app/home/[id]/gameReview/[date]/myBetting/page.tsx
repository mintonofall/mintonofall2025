        ...
        <div className="p-8 flex flex-col items-center min-h-screen bg-linear-to-b from-emerald-50 via-white to-white pt-16">
            ...
            <div className="w-full max-w-3xl bg-white p-4 sm:p-6 rounded-lg shadow-md">
                {bets.length > 0 ? (
                    <ul className="divide-y divide-slate-200">
                        {bets.map((bet) => {
                            ...
                            return (
                                <li
                                    key={bet.id}
                                    className="py-4 flex flex-col justify-between gap-4 border-b border-slate-100 last:border-0"
                                >
                                    <div className="flex flex-col sm:flex-row justify-between items-center gap-2 w-full">
                                        <div className="flex-grow text-center sm:text-left">
                                            <p className="text-lg font-semibold text-slate-800">경기 ID: {bet.gameid}</p>
                    ...
                    <div className="text-center text-slate-500 py-8">해당 날짜에 베팅한 내역이 없습니다.</div>
                )}
            </div>
        </div>
    );
