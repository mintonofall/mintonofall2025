        ...
        <div className="h-[70%] border p-4 bg-gray-50">
            <div className="grid grid-cols-[1fr_4fr_4fr_4fr_4fr] grid-rows-7 gap-1 h-full">
                ...
                {Array.from({ length: 35 }).map((_, index) => {
                    ...
                    if (index % 5 === 0) {
                        const p1 = gridData[index + 1];
                        const p2 = gridData[index + 2];
                        const p3 = gridData[index + 3];
                        const p4 = gridData[index + 4];
                        canStartGame = !!(p1?.isSaved && p2?.isSaved && p3?.isSaved && p4?.isSaved);
                    }
                    return (
                        <div
                            key={index}
                        ...
                        >
                            ...
                            {index % 5 === 0 ? (
                                <button
                                    ...
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        if (canStartGame) onGameStart?.(index);
                                    }}
                                >
                                    게임 시작
                                </button>
