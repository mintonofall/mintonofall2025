...
async function getTeams(leagueId: number) {
    ...
    const games = await getResult("2024-12-11");
...
async function getTeamStats(team: TeamWithScores | undefined, opponent: TeamWithScores | undefined, round: number) {
    ...
    if (round === 1) {
        ...
        if (currentTeam?.firstRoundResult === null && win > lose) {
...
export default async function RunningLeague({ params }: { params: PageParams }) {
    ...
    const team1Stats = await getTeamStats(firstTeam, secondTeam, 1);
    const team2Stats = await getTeamStats(secondTeam, firstTeam, 1);
    const team3Stats = await getTeamStats(thirdTeam, fourthTeam, 1);
    const team4Stats = await getTeamStats(fourthTeam, thirdTeam, 1);
            ...
            <main className="p-8">
                ...
                <div className="mt-8 flex gap-8">
                    <div className="w-1/2 border rounded-lg p-6 shadow-md bg-gray-50">
                        <h3 className="text-xl font-bold text-center mb-4">경기 결과</h3>
                        <div className="flex justify-around items-center">
                            <div className="text-center">
                                <p className="font-bold text-lg mb-1">{firstTeam?.user.nickName}</p>
                            ...
                            <div className="text-center">
                                <p className="font-bold text-lg mb-1">{secondTeam?.user.nickName}</p>
                    ...
                    <div className="w-1/2 border rounded-lg p-6 shadow-md bg-gray-50">
                        ...
                        <div className="flex justify-around items-center">
                            <div className="text-center">
                                <p className="font-bold text-lg mb-1">{thirdTeam?.user.nickName}</p>
                                <p className="text-2xl font-bold text-blue-600">
                            ...
                            <div className="text-center">
                                <p className="font-bold text-lg mb-1">{fourthTeam?.user.nickName}</p>
                                <p className="text-2xl font-bold text-red-600">
